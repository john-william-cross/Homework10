...
public class DeckOfCards {
    ...
    public static void main(String[] args) {
        HashMap<String, List> cardDeck = new HashMap<String, List>();               //created hashmap called cardDeck with key of String and a value filled with an integer list
        ArrayList<Integer> cardValues = new ArrayList<Integer>();                //created the array list called cardValues that goes in the value of the map
